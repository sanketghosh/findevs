  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2 rounded-md border p-4 shadow-sm lg:flex-row lg:items-center">
        <div className="flex size-12 shrink-0 items-center justify-center rounded-md bg-destructive text-white">
          <MegaphoneIcon />
        </div>
        <div>
      ...
      <div className="relative flex flex-col gap-6 md:flex-row">
        ...
        <aside className="flex h-fit w-full shrink-0 flex-col gap-4 rounded-md border p-4 shadow-sm md:w-80 lg:w-96">
          {/* job status */}
          <div className="w-fit rounded-md border bg-secondary px-3 py-2">
          ...
          <div className="space-y-4 font-medium">
            <div className="space-y-2">
              ...
              <h1 className="w-fit rounded-sm bg-amber-400 px-5 py-2 text-lg font-semibold dark:bg-orange-600 lg:text-xl">
                <b>Salary: </b>
                {salary}
              </h1>
            </div>
